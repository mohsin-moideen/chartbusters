...
@Component({
    selector: 'jhi-rating-chartbusters',
    templateUrl: './rating-chartbusters.component.html'
})
export class RatingChartbustersComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: RatingChartbusters) {
        return item.id;
    }
