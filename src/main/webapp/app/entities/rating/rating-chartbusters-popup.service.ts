...
@Injectable()
export class RatingChartbustersPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.ratingModalRef(component, new RatingChartbusters());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    ratingModalRef(component: Component, rating: RatingChartbusters): NgbModalRef {
