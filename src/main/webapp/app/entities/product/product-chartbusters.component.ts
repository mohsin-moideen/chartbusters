...
@Component({
    selector: 'jhi-product-chartbusters',
    templateUrl: './product-chartbusters.component.html'
})
export class ProductChartbustersComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ProductChartbusters) {
        return item.id;
    }
