...
public class RatingResourceIntTest {
    ...
    private static final Double DEFAULT_RATING_VALUE = 1D;
    private static final Double UPDATED_RATING_VALUE = 2D;

    private static final Long DEFAULT_REVIEW_COUNT = 1L;
    private static final Long UPDATED_REVIEW_COUNT = 2L;

    private static final Boolean DEFAULT_HAS_REVIEW = false;
    private static final Boolean UPDATED_HAS_REVIEW = true;
    ...
    public void createRating() throws Exception {
        ...
        assertThat(testRating.getRatingValue()).isEqualTo(DEFAULT_RATING_VALUE);
        assertThat(testRating.getReviewCount()).isEqualTo(DEFAULT_REVIEW_COUNT);
        assertThat(testRating.isHasReview()).isEqualTo(DEFAULT_HAS_REVIEW);
    ...
    public void getAllRatings() throws Exception {
        ...
        restRatingMockMvc.perform(get("/api/ratings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ratingValue").value(hasItem(DEFAULT_RATING_VALUE.doubleValue())))
            .andExpect(jsonPath("$.[*].reviewCount").value(hasItem(DEFAULT_REVIEW_COUNT.intValue())))
            .andExpect(jsonPath("$.[*].hasReview").value(hasItem(DEFAULT_HAS_REVIEW.booleanValue())));
    }
    ...
    public void getRating() throws Exception {
        ...
        restRatingMockMvc.perform(get("/api/ratings/{id}", rating.getId()))
            ...
            .andExpect(jsonPath("$.ratingValue").value(DEFAULT_RATING_VALUE.doubleValue()))
            .andExpect(jsonPath("$.reviewCount").value(DEFAULT_REVIEW_COUNT.intValue()))
            .andExpect(jsonPath("$.hasReview").value(DEFAULT_HAS_REVIEW.booleanValue()));
    }
    ...
    public void updateRating() throws Exception {
        ...
        Rating testRating = ratingList.get(ratingList.size() - 1);
        assertThat(testRating.getRatingValue()).isEqualTo(UPDATED_RATING_VALUE);
        assertThat(testRating.getReviewCount()).isEqualTo(UPDATED_REVIEW_COUNT);
        assertThat(testRating.isHasReview()).isEqualTo(UPDATED_HAS_REVIEW);
