...
import com.chartbusters.domain.Category;
import com.chartbusters.repository.CategoryRepository;
import com.chartbusters.repository.search.CategorySearchRepository;
...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCountryName()).isEqualTo(DEFAULT_COUNTRY_NAME);
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getCountryName()).isEqualTo(UPDATED_COUNTRY_NAME);
