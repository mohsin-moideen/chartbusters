...
public class ReviewResourceIntTest {
    ...
    private static final String DEFAULT_REVIEW_BODY = "AAAAAAAAAA";
    private static final String UPDATED_REVIEW_BODY = "BBBBBBBBBB";
    ...
    public void createReview() throws Exception {
        ...
        assertThat(testReview.getDatePublished()).isEqualTo(DEFAULT_DATE_PUBLISHED);
        assertThat(testReview.getReviewBody()).isEqualTo(DEFAULT_REVIEW_BODY);
    ...
    public void getAllReviews() throws Exception {
        ...
        restReviewMockMvc.perform(get("/api/reviews?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].reviewBody").value(hasItem(DEFAULT_REVIEW_BODY.toString())));
    }
    ...
    public void getReview() throws Exception {
        ...
        restReviewMockMvc.perform(get("/api/reviews/{id}", review.getId()))
            ...
            .andExpect(jsonPath("$.reviewBody").value(DEFAULT_REVIEW_BODY.toString()));
    }
    ...
    public void updateReview() throws Exception {
        ...
        updatedReview
            ...
            .reviewBody(UPDATED_REVIEW_BODY);
        ...
        assertThat(testReview.getDatePublished()).isEqualTo(UPDATED_DATE_PUBLISHED);
        assertThat(testReview.getReviewBody()).isEqualTo(UPDATED_REVIEW_BODY);
